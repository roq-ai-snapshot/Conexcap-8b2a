...
const LinkItems: Array<LinkItemProps> = [
  ...
  {
    name: 'halal_investment_product',
    path: '/halal-investment-products',
    entity: 'halal_investment_product',
    service: AccessServiceEnum.PROJECT,
    icon: FiHome,
  },
  { name: 'investment', path: '/investments', entity: 'investment', service: AccessServiceEnum.PROJECT, icon: FiHome },
  {
